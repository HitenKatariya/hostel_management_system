...
body {
    position: relative; /* Set position relative to use the ::before pseudo-element */
...
body::before {
    ...
    width: 100%;
    height: 100%;
    background-image: url('DIVINEHOSTEL.png'); /* Check the image path */
...
.container {
    ...
    z-index: 1; /* Ensure the container is on top of the background */
}
