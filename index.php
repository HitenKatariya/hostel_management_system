...
<header>
    <nav class="nav">
        ...
        <ul class="nav-links">
            ...
            <li style="color: white;">My Profile (<?php echo $_SESSION['username']; ?>)</li> <!-- My Profile as plain text -->
        </ul>
        ...
        <div class="bg" style="background-image: url('main.png');">
            ...
            <div class="cards-container">
                ...
                <a href="complaint.php" class="card" id="comp">
        ...
        <footer class="footer" id="footer">
            ...
            <div class="inquiry-section" id="footer">
    <div class="inquiry-form">
        ...
        <form action="" method="POST">
            ...
            <button type="submit" name="inquiry_submit">Submit</button>
        </form>
    </div>
</div>
